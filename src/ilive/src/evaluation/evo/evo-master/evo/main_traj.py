...
def parser() -> argparse.ArgumentParser:
    ...
    output_opts.add_argument("--save_as_tum",
                             ...
                             action="store_true")
    output_opts.add_argument('--save_path', help="where to save tum file")
    ...
    if args.plot or args.save_plot or args.serialize_plot:
        ...
        if args.save_plot:
            ...
            plot_collection.export(args.save_plot,
                                   confirm_overwrite= args.no_warnings)
    ...
    if args.save_as_tum:
        ...
        for name, traj in trajectories.items():
            ...
            file_interface.write_tum_trajectory_file(
                dest, traj, confirm_overwrite= args.no_warnings)
        if args.ref:
            dest = to_filestem(args.ref, args) + ".tum"
            file_interface.write_tum_trajectory_file(
                dest, ref_traj, confirm_overwrite= args.no_warnings)
